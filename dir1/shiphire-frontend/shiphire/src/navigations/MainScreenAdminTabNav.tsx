...
import { AdminHome } from '../screens/main/admin/home';
import { AdminAccount } from '../screens/main/admin/account';

const Tab = createBottomTabNavigator<MainScreenAdminParamList>();

const MainScreenAdminTabNav: React.FC = () => {
    const iconMapping: {
        [key: string]: {
            active: any;
            inactive: any;
...
export default MainScreenAdminTabNav;
