...
const EditRFQInputFormOwner: React.FC<EditRFQInputFormOwnerProps> = ({
    navigation,
    route,
}) => {
    ...
    const mutationEditRFQDynamicInput = useEditDynamicInputOwner();
                ...
                {({
                    ...
                    <>
                        ...
                        <View>
                            <CheckBox
                                testID="cb-required"
                                checked={initialRequireCheck}
                                checkedIcon={<CheckboxCheckedIcon />}
                                uncheckedIcon={<CheckboxIcon />}
                                onPress={() => {
                                    setInitialRequireCheck(
                                        !initialRequireCheck,
                                    );
                        ...
                        <View
                            ...
                            <CustomButton
                                testID="add-button"
                                title={t(
                                    'RFQFormInputView.textButtonEditDynamicInput',
                                )}
...
export default EditRFQInputFormOwner;
