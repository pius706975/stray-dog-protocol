            ...
            <View
                ...
                <View
                    ...
                    <View
                        ...
                        <TextInput
                            leftIcon
                            placeholder={t('ShipOwner.EditTransactionHistory.textDocumentName')}
                            label={t(
                                'ShipOwner.AddTransactionHistory.textDocumentName',
                            )}
                        ...
                        {docName === '' && error.name && (
                            <TextInputError
                                errorText={t(
                                    'ShipOwner.AddTransactionHistory.validationDocumentName',
                                )}
                            />
                        )}
                    </View>
                    <View
                        ...
                        <View paddingB-25>
                            <CustomText
                                ...
                                fontFamily="medium">
                                {t(
                                    'ShipOwner.AddTransactionHistory.textDocument',
                                )}
                            </CustomText>
                        </View>
                        <View paddingB-15>
                                ...
                                <Pressable
                                    ...
                                    <View
                                        ...
                                        <CustomText
                                            ...
                                            fontSize="md">
                                            {t(
                                                'ShipOwner.AddTransactionHistory.textSelectFile',
                                            )}
                                        </CustomText>
                                        <PlusIcon />
                                    </View>
                        ...
                        {selectedFile === null && error.doc && (
                            <View
                                ...
                                <TextInputError
                                    errorText={t(
                                        'ShipOwner.AddTransactionHistory.validationDocument',
                                    )}
                                />
                            </View>
                        )}
                    ...
                    <View row style={{ justifyContent: 'center' }}>
                        <View
                            ...
                            <CustomButton
                                title={t(
                                    'ShipOwner.AddTransactionHistory.textCancel',
                                )}
                                onSubmit={onClose}
                                color="error"
                            />
