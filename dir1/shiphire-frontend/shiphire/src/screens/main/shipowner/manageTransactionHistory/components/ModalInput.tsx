                ...
                <View
                    ...
                    <View
                        ...
                        {docName === '' && error.name && (
                            <TextInputError
                                errorText={t(
                                    'ShipOwner.EditTransactionHistory.validationDocumentName',
                                )}
                            />
                        )}
                    </View>
                    <View
                        ...
                        <View paddingB-25>
                            <CustomText
                                ...
                                fontFamily="medium">
                                {t(
                                    'ShipOwner.EditTransactionHistory.textDocument',
                                )}
                            </CustomText>
                        </View>
                        <View paddingB-15>
                                ...
                                <Pressable
                                    ...
                                    <View
                                        ...
                                        <CustomText
                                            ...
                                            fontSize="md">
                                            {t(
                                                'ShipOwner.EditTransactionHistory.textSelectFile',
                                            )}
                                        </CustomText>
                                        <PlusIcon />
                                    </View>
                        ...
                        {selectedFile === null && error.doc && (
                            <View
                                ...
                                <TextInputError
                                    errorText={t(
                                        'ShipOwner.EditTransactionHistory.validationDocument',
                                    )}
                                />
                            </View>
                        )}
                    ...
                    <View row style={{ justifyContent: 'center' }}>
                        <View
                            ...
                            <CustomButton
                                title={t(
                                    'ShipOwner.EditTransactionHistory.textCancel',
                                )}
                                onSubmit={onClose}
                                color="error"
                            />
                        ...
                        <View
                            ...
                            <CustomButton
                                ...
                                title={t(
                                    'ShipOwner.EditTransactionHistory.textAddDocument',
                                )}
