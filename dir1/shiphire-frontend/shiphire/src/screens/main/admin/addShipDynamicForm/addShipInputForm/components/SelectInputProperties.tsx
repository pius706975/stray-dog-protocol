...
import { AddShipDropdownInputRequest } from '../../../../../../types';
...
const SelectInputProperties = ({ selectItem, setSelectItem, templateType }) => {
    ...
    const handleForm = (
        ...
        const payload = {
            ...
            unit: values.unit,
            templateName: `${templateType}Spec`,
        };
                            ...
                            <>
                                <View paddingB-20 marginT-10>
                                    ...
                                    <View paddingH-8 marginT-10>
                                        <CustomButton
                                            testID="btn-add-input-additional"
                                            title="Add Input"
