...
const verifStackNavMockComponent = () => (
    <QueryClientProvider client={queryClient}>
        <Provider store={store}>
            <NavigationContainer>
                <MainStack.Navigator>
                    <MainStack.Screen name="VerifPhone" component={VerifyPhone} />
                </MainStack.Navigator>
            </NavigationContainer>
        </Provider>
    </QueryClientProvider>
...
describe('Verif email component', () => {
    it('should render the screen',async () => {
        ...
        await act(async() => {
        expect(getByTestId('VerifyPhoneScreen')).toBeDefined();
})
    })
    ...
    it('should verify the code', async () => {
        ...
        mockAdapter
            .onPost('/renter/verify-phone-number-otp')
