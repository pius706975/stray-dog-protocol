...
import { GuestHomeProps, ShipDatas } from '../../../../types';
import { HeaderHome, ShipListView, TopRateShipComponent } from './component';
import { useIsFocused } from '@react-navigation/native';

const Home: React.FC<GuestHomeProps> = ({ navigation }) => {
